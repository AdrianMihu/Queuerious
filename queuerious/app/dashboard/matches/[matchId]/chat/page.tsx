          ...
          <div className="relative shrink-0 border-t border-white/[0.07] bg-[#0d0d12] p-4 sm:p-5">
            ...
            <div className="mx-auto flex max-w-3xl items-end gap-3">
              ...
              <input
                ...
                className="h-11 min-w-0 flex-1 rounded-xl border border-white/[0.07] bg-white/[0.035] px-4 text-sm text-white outline-none transition placeholder:text-white/25 focus:border-violet-400/25 focus:bg-white/[0.05]"
              />
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
    <div className="w-full max-w-md rounded-3xl border border-white/[0.08] bg-[#15151c] p-6 shadow-2xl">
      ...
      <p className="mt-2 text-sm leading-relaxed text-white/45">
        You will no longer be matched with {match.name}.
        This chat will disappear from your matches.
      </p>
