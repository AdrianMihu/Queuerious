          ...
          <div className="relative">
            ...
            <div className="max-w-2xl">
              ...
              <p className="mt-5 max-w-xl leading-relaxed text-white/50">
                Start queueing and get matched with someone based on curiosity,
                conversation and connection — before either of you sees a
                profile.
              </p>
            </div>
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              >
                <Zap size={18} className="transition group-hover:fill-white" />
                Start Queueing
                <ChevronRight
                  size={18}
              ...
              <div className="flex items-center gap-3 text-sm text-white/35">
                <div className="flex -space-x-1">
                  ...
                  <div className="h-2 w-2 rounded-full bg-violet-400/40" />
                </div>
                3 free queues available
              </div>
            </div>
          </div>
        </div>
